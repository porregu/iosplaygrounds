...
let laterthatday = customerOrderOne + customerOrderSix + customerOrderTwo + customerOrderFive + customerOrderFour + customerOrderThree
/*:
 ...
 */
let serverResponseToTableTwo = "Let me make sure I've got this right:" + laterthatday
