...
let noun = "airpods"
let place = "store"
let positiveemotion = "good"
let negativeemotion = "bad"
let fullsentence = "today was a big day for, \(nme) . they had finally up, \(number) dollars and were going to buy a  \(adjective + noun) . They went to the \(noun + place) feeling very \(positiveemotion) . But then they felt \(negativeemotion) . They were all out of \(noun)"
//:
//:
